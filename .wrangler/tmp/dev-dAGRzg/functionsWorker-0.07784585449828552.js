...
// .wrangler/tmp/pages-NTTksJ/functionsWorker-0.07784585449828552.mjs
...
async function onRequestPost({ request, env }) {
  ...
  try {
    ...
    ).bind("login_attempt", role, ip, (/* @__PURE__ */ new Date()).toISOString()).run();
  } catch (e) {
...
async function onRequestGet({ env }) {
  try {
    ...
    return new Response(JSON.stringify({
      upcomingExams: [
        { id: "1", title: "Ph\xE2n t\xEDch nh\xE2n v\u1EADt L\xE3o H\u1EA1c", type: "exercise", deadline: "2026-03-22" },
        { id: "2", title: "\u0110\u1EC1 thi gi\u1EEFa k\u1EF3", type: "exam", deadline: "2026-03-25" }
      ],
      recentResults: [
        { submissionId: "r1", examTitle: "Ngh\u1ECB lu\u1EADn x\xE3 h\u1ED9i", examType: "exercise", teacherScore: 8.5, aiScore: 9, teacherComment: "T\u1ED1t l\u1EAFm!" }
      ]
    }), {
      headers: { "Content-Type": "application/json" }
    });
...
// .wrangler/tmp/bundle-Hkvcdy/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Hkvcdy/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.07784585449828552.js.map
