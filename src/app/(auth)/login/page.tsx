      ...
      <main className="min-h-screen pt-32 pb-20 flex items-center justify-center px-6 relative z-10">
        ...
        >
          ...
          <div className="md:w-1/2 relative min-h-[400px] bg-primary-container overflow-hidden group">
            ...
            {/* Foreground Art Image */}
            <div className="absolute inset-0 flex items-center justify-center p-12"
              style={{ animation: "fadeIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) 0.2s both" }}
            >
              <div className="relative w-full h-full rounded-xl overflow-hidden shadow-2xl group-hover:shadow-3xl transition-shadow duration-700">
                <img alt="Traditional Vietnamese motifs" className="w-full h-full object-cover opacity-80 group-hover:scale-105 transition-transform duration-700" src="/images/login_background.png" />
