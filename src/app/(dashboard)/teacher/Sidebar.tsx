    ...
    <aside className="bg-[#1B4F72] dark:bg-[#002842] h-screen w-72 fixed left-0 top-0 overflow-y-auto z-40 flex flex-col py-8 justify-between shadow-2xl shadow-blue-900/20">
      ...
      <div className="px-6 space-y-4">
        <div className="flex items-center gap-3 px-2 py-3">
          <img alt="Cô Lan" className="w-10 h-10 rounded-full object-cover border-2 border-white/20" src="/images/teacher_portrait.png" />
          <div>
        ...
        <div className="pt-4 border-t border-white/10 space-y-1">
          <Link className="flex items-center gap-3 px-4 py-2 text-blue-100/60 hover:text-white hover:bg-white/5 rounded-lg transition-all" href="/login">
