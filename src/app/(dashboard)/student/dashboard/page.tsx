      ...
      <div className="pt-24 pb-12 px-10 max-w-6xl mx-auto">
        ...
        <section className="mb-16">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link className="text-sm font-semibold text-primary hover:underline" href="/student/exam-room">Tất cả bài tập</Link>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {upcomingExams.map((exam: any, index: number) => (
              <Link key={exam.id || index} href={`/student/exam-room/${exam.id}`} className="bg-white/80 backdrop-blur-md rounded-2xl border-[0.5px] border-outline-variant/30 p-6 flex flex-col h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group">
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            ...
            <Link className="text-sm font-semibold text-primary hover:underline" href="/student/results">Xem học bạ</Link>
          </div>
              ...
              >
                ...
                {expandedResult === index && (
                  <div className="px-6 pb-6 border-t border-outline-variant/10 pt-4 space-y-3 animate-[fadeIn_0.2s_ease-out]">
                    ...
                    <Link href="/student/results" className="text-sm font-bold text-primary hover:underline inline-flex items-center gap-1">
